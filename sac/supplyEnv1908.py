    ...
    def save_to_csv(self, filename=None):
        ...
        for i in range(len(self.state_history)):
            row = {
                ...
                "action_2_SHOW_Percent": self.percent_history[i][2][0],  ### 0 or 1
    ...
    def render(self, mode="human", log_dir='./plots'):
        ...
        # for ep in range(num_periods):
            ...
            for i in range(2):
                ...
                percent_label_str = ', '.join(percent_labels[len(self.percent_history)-1]) if percent_labels else 'N/A'
