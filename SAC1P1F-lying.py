...
from supplyEnv import POMultiAgent1W1F, POMultiAgent1W1F_V1T1,POMultiAgent1W1F_V1T2,POMultiAgent1W1F_V1T3,POMultiAgent1W1F_V1T4
#,POMultiAgent1W1F_V2T1,POMultiAgent1W1F_V2T2,POMultiAgent1W1F_V2T3,POMultiAgent1W1F_V3T1,POMultiAgent1W1F_V3T2,POMultiAgent1W1F_V3T3
...
if __name__ == '__main__':
   ...
   # elif args.env9:
    ...
    env = envs()
    save_dir = f"D{env.dist}B{env.b}_S{env.s}_T{env.task}_{now_str}"
    # dir to save plots
    plots_dir = 'plots'
    ...
    config = SACConfig().environment(env=envs).multi_agent( 
